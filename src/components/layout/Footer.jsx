      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/auth" className="text-gray-300 hover:text-[#00C853] transition-colors">
                  Registro
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-300 hover:text-[#00C853] transition-colors">
                  Nosotros
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-[#00C853] transition-colors">
                  Contacto
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300 text-sm">dentameet.devs@gmail.com</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4 text-[#00C853]" />
                <span className="text-gray-300 text-sm">+56 9 57384302</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300 text-sm">
            © 2025 DentaMeet - PacienteFácil. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
